          ...
          <div className={styles.Top_TechSelection_style}>
            ...
            <p>
              <Image
                ...
                priority
              />
              (Material UI)は、Googleのマテリアルデザインを実装したReactのUIコンポーネントライブラリです。美しく使いやすいUIを短期間で開発でき、ユーザーエクスペリエンスの向上に貢献します。また、豊富なコンポーネントやテーマカスタマイズ機能を利用でき、ブランドイメージに合ったデザインが実現可能です。
            </p>
            <br />
            <br />
            <p>
